...
async def save_image(file: UploadFile, max_width: int = 1024, max_height: int = 1024, quality: int = 85) -> str:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Rasmni saqlashda xatolik yuz berdi: {str(e)}")
